...
public class AdicionarCarrinho {
	...
	public void cadastrarItemCarrinho(int cliente) {
		...
		try {
			...
			AtualizarEstoque(idDoProduto, resultset.getInt("quantidade"), produto.getQuantidadeDeProduto());
	...
	public void AtualizarEstoque(int id, int quantidade, int quantidadecarrinho) {
	
		try {
			int quant = quantidade-quantidadecarrinho;
